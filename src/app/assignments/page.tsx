...
function FilterSection({
  ...
  setSelectedAuditor: (v: string) => void;
  searchQuery: string;
...
function AuditorStats({ stats }: { stats: { ledCount: number; memberCount: number } | null }) {
        ...
        <CardContent className="pt-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h4 className="text-3xl font-bold">{stats.ledCount}</h4>
            </div>
        ...
        <CardContent className="pt-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h4 className="text-3xl font-bold">{stats.memberCount}</h4>
            </div>
...
export default function AssignmentsPage() {
  ...
  const filteredFindings = useFilteredFindings(findings, selectedAuditor, searchQuery);
  const auditorStats = useAuditorStats(findings, selectedAuditor);
    ...
    <div className="flex min-h-screen w-full flex-col bg-background">
      ...
      <main className="flex-1 p-4 sm:p-6 md:p-8">
        <div className="mx-auto max-w-7xl space-y-6">
          ...
          />
          <AuditorStats stats={auditorStats} />
